    ...
    <main>
      <section id="hero" className="h-[400px] bg-otomotif bg-center bg-cover bg-no-repeat text-center">
        <div className="mx-auto flex justify-center items-center backdrop-brightness-50 h-full min-w-full w-full">
          <div className="mx-10">
            <h1 className="md:text-5xl text-4xl font-bold leading-tight my-5 capitalize font-primary text-white">Spare Parts Otomotif</h1>
            <p className="text-xl font-secondary mb-5 text-gray-300">
              Kami menyediakan beragam spare parts untuk kebutuhan otomotif. 
            </p>
          </div>
        </div>
      </section>
      {sparePartOtomotif.map(item => (
