...
const Contact = () => {
  return (
    <main>
      <section className="h-[600px] text-gray-600 body-font relative">
            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="text-primary block text-base font-semibold text-red-600">
                    Hubungi Kami
                  </span>
                  <h2
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="text-dark mb-1 text-xl font-bold">Alamat E-mail</h4>
                      <p className="text-body-color text-base">admin@cvkaryatama.com</p>
                      <p className="text-body-color text-base">marketing@cvkaryatama.com</p>
                    </div>
                  </div>
                </div>
              </div>
